...
impl DemoApp {
    fn load_shaders(&mut self) {
        ...
        self.shader_program
            .vertex_shader("assets/shaders/interpolation/interpolation.vs.glsl")
            .fragment_shader("assets/shaders/interpolation/interpolation.fs.glsl")
            .link();
    }
}
...
fn main() -> Result<()> {
    ...
    run_application(app, "Interpolation")
}
